...
```{r misc_function, eval=T, echo=F, warnings=F, warn=F}
    rm(list = ls())   
    graphics.off()
    ...
    library <- function(package, help, pos = 2, lib.loc = NULL, character.only = FALSE,
       ...
       suppressPackageStartupMessages(library.warn(
        ...
        suppressWarnings(library(gutenbergr))
...
`{python echo=F, include=T, eval=T, engine.path="C:/Users/Steve/Anaconda3/python"}`  
...
```{python echo=F, eval=T, include=F, engine.path="C:/Users/Steve/Anaconda3/python"}
import pandas
import feather
import csv
...
```{python, eval=T, echo=T, include=T, engine.path="C:/Users/Steve/Anaconda3/python"}
import pandas as pd
import numpy as np
